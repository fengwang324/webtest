  ...
  <table width="80%" align="center" border=1 cellspacing=0 cellpadding=1 bordercolorlight=#5BD77D bordercolordark=#ffffff>
    <tr>
                ...
                <table width="80%" height="156" border="0" align="center" cellpadding="0" cellspacing="0" class="tableborder">
                  ...
                  <tr> 
                    <td width="24%" height="30" align="right">请输入您的用户名：&nbsp;</td> 
                    <td width="76%"> 
                  ...
                  <tr> 
                    ...
                    <td><input name="code" type="text" id="code" size="8" maxlength="4">
					<%
					dim num1
					dim rndnum
					Randomize
                  ...
                  <tr> 
                    <td height="150" colspan="2"> 　说明：如果通过“取回密码”不能成功取回密码，请致电<%=application("sitename")%>网服务中心。</td>
                  </tr>
                </table>
              </form>
            </TD>

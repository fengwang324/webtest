...
<script>
        window.g_hb_monitor_st = +new Date();
                window.g_config = {appId: 3, assetsHost: "http://a.tbcdn.cn/", toolbar: false, pageType: "tmall",shopId: "105124646",sellerId: "1744773663",wtId:"2079482315",showShopQrcode:true};
                window.shop_config = {
            "shopId": "105124646",
            "siteId": "2",
            "userId": "1744773663",
...
<script src="http://g.tbcdn.cn/??kissy/k/1.3.0/seed-min.js,mui/global/1.2.14/global.js"></script>
...
<style>
    ...
    <style>
          #content{
background:url(images/T1S.WAFv8cXXb1upjX) repeat left 0 ;
}
#hd{
background:url(images/T1Z9GFFtRdXXb1upjX.jpg) no-repeat center 0 #FFF;
}
  ...
  <tr>
    <td valign="top"><table width="98%" border="0" cellpadding="2" cellspacing="0" class="kindbg" >
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0" >
        <tr>
          <td valign="top"><p><span class="large"> &nbsp; &nbsp; 美國德玉堂腫瘤研究中心是一家集研發、加工、生產和銷售為一體的跨國保健品股份有限公司，公司由數十位享譽世界具有40多年豐富臨床經驗的中草藥研究專家創辦而成，經美國加利福尼亞州政府批准於2002年註冊成立，公司前身是孫氏保健中心。</span><span class="text"><br />
            </span><span class="large"> &nbsp; &nbsp; 孫德玉教授是四代祖傳中醫，具有40多年腫瘤臨床經驗，她是應用中草藥防癌抗癌的先驅。早在15年前就成功研製出"癌健消"，即現在的"美國靈草百消丹"，因療效顯著，於1996年榮獲加拿大保健品金杯獎 。經過十幾年的臨床使用和改良，應用現代高科技技術，採用純天然名貴優質中藥材精製而成。如今的"美國靈草百消丹"的品種已多達28種系列，針對乳腺、子宮頸、肺、腸、淋巴、鼻咽、胰腺、腦等，不同的病症使用不同的編號，對症選用。一般使用三個療程左右（90天）症狀有顯著的改善，"美國靈草百消丹"已遍佈美國，遠銷加拿大、英國、法國、德國、新加坡、澳大利亞、馬來西亞、韓國、朝鮮、印尼、菲律賓、泰國、墨西哥、日本、中國大陸、臺灣、香港、澳門等國家和地區，所到之處深得消費者的好評和當地多家權威媒體的青睞。</span><a href="zj.asp" class="img"><font color="#FF0000">更多&gt;&gt;&gt;</font></a><br />
          </p></td>
        </tr>
    </table></td>

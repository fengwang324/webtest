...
Class SelectPic
		...
		.echo "</style>"
		.echo "</head>"
		.echo "<script language=""JavaScript"" src="""&rootDir&"/common/Common.js""></script>"
		...
		.echo "{"
		.echo "  OpenWindow('Frame.asp?PageTitle='+escape('上传文件')+'&FileName=UpFileForm.asp&Path='+frames[""FolderList""].CurrPath,400,200,window);"

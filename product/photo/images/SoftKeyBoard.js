...
function OverInput() {
    if (Calc.password.value=='')
	{
	 ...
	 return;
	  ...
	  if (Calc.password.value.length<5)
	{
    alert('密码不能少于五位！');
	 return;
	}

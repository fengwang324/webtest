...
Class UpFileForm
		...
		Response.Write "<link rel=""stylesheet"" href=""" &rootDir & "/common/Editor.css"">"
		Response.Write "<link href=""../common/admin_style.css"" rel=""stylesheet"" type=""text/css"">"
		Response.Write "</head>"
		...
		Response.Write "    <tr>"
		Response.Write "      <td><div>&nbsp;请稍等，正在上传文件<img src='../images/wait.gif' align='absmiddle'></div></td>"

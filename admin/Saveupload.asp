...
for each formName in upload.file ''列出所有上传了的文件
 ...
 if file.filesize>300*1024 then
 	response.write "<font size=2>图片大小超过了限制(300*1024字节)　[ <a href=# onclick=history.go(-1)>重新上传</a> ]</font>"
	response.end
 end if
...
next
 response.write "<font size=2 color=red><br>上传成功。<br><br><font size=2 color=blue>&lt;div align=center&gt;&lt;img src="&FileName&"&gt;&lt;/div&gt;</font><br></font>"
'response.end

  response.write "<script language=JavaScript>" & "window.opener.document.theForm.c_contect.value =window.opener.document.theForm.c_contect.value + '<img src="&managerfolder&"/"&FileName&" border=0>';" &"alert('相片大图上传成功!');"& "window.close();" & "</script>"

' response.write "<font size=2 color=red><br>上传成功,下边的链接是您的图片链接，请勿改动。将路径复制到输入框适当位置即可。<br><br><font size=2 color=blue>&lt;br&gt;&lt;div align=center&gt;&lt;img src="&FileName&"&gt;&lt;/div&gt;&lt;br&gt;</font><br><br><div align=center><a href='javascript:history.back()'>再上传图片</a></div></font>"

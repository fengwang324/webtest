...
%>
    ...
    <tr> 
      ...
      <td><p> 
		  ...
		  <textarea id="c_contect" name="c_contect" cols="100" rows="8" style="width:725px;height:400px;visibility:hidden;"><%=htmlspecialchars(c_contect1)%></textarea>
